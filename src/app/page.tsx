...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://cv.luanmuniz.com.br/opengraph-image",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: `${RESUME_DATA.name} - Resume`,
    description: RESUME_DATA.about,
    images: ["https://cv.luanmuniz.com.br/opengraph-image"],
  },
};
  ...
  return (
    <>
      ...
      >
        ...
        <section
          className="mx-auto w-full max-w-4xl space-y-8 bg-white print:space-y-4 dark:bg-background"
